...
export interface ApiFreelanceFreelance extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    printable: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiProfileProfile extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    languages: Schema.Attribute.Component<'profile.languages', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    skills: Schema.Attribute.Component<'profile.skill', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
